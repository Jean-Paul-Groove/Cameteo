...
import partlyCloudyNight from "../assets/icons8-partly-cloudy-night-50.png";
import lightRainNight from "../assets/icons8-rain-cloud-night-50.png";
export const weatherCodeEnum: {
  [index: number]: { icon: string; description: string; iconNight?: string };
} = {
  0: { description: "Ciel dégagé", icon: sunny, iconNight: moon },
  1: {
    description: "Légerement couvert",
    icon: partlyCloudy,
  ...
  51: {
    description: "Faible bruine",
    icon: lightRain,
    iconNight: lightRainNight,
  },
  53: { description: "Bruine", icon: lightRain, iconNight: lightRainNight },
  ...
  81: { description: "Averses", icon: lightRain, iconNight: lightRainNight },
